...
Route::post('/currencyCalculator','FrontendController@currencyCalculator')->name('currencyCalculator');
...
/**route by radha from localcryptos */
    Route::resource('tokens', 'TokensController',[
        'names' => [
			...
			'update'   => 'admin.tokens.update',
            'destroy' => 'admin.tokens.destroy',
        ],
    ]);
    Route::post('tokens/table',['as'=>'admin.tokens.table','uses'=>'TokensController@table'])->middleware('ajax'); 
    Route::post('tokens/toggle-status/{id}',['as'=>'admin.tokens.toggle_status','uses'=>'TokensController@toggle_status'])->middleware('ajax');
    Route::post('tokens/mass-toggle',['as'=>'admin.tokens.masstoggle','uses'=>'TokensController@toggle_statuses'])->middleware('ajax');
    Route::post('tokens/mass-delete',['as'=>'admin.tokens.massdelete','uses'=>'TokensController@delete'])->middleware('ajax');
	...
	Route::post('/services/deposit', [
		'as' => 'services.deposit',
        'uses' => 'ServicesController@deposit',
    ])->middleware('ajax');
	
	Route::post('/services/withdraw', [
		'as' => 'services.withdraw',
        'uses' => 'ServicesController@withdraw',
    ])->middleware(['ajax']);
		
	Route::post('/services/voucher', [
        'as'   => 'services.loadvoucher',
        'uses' => 'ServicesController@loadVoucher',
    ])->middleware(['ajax']);
	
	Route::post('/services/serial', [
        'as'   => 'services.validateserial',
        'uses' => 'ServicesController@validateSerial',
    ])->middleware(['ajax']);
	
	Route::get('/wallet/{symbol}', [
		'as' => 'wallet',
        'uses' => 'ServicesController@wallet',
    ]);
	
	Route::get('/service/{symbol}', [
		'as' => 'services.show',
        'uses' => 'ServicesController@wallet',
    ]);
	
	Route::post('service_txs/table/{id}',['as'=>'service_txs.table','uses'=>'ServicesController@txtable'])->middleware('ajax');
	...
	Route::post('services/table',['as'=>'admin.services.table','uses'=>'ServicesController@table'])->middleware('ajax');
	Route::post('services/faucet',['as'=>'admin.services.faucet','uses'=>'ServicesController@faucet'])->middleware('ajax');
    
    // trades
	Route::resource('trades', 'TradesController',[
        'only'=>['index','show','update' ,'destroy'],
        'names' => [
           'index'   => 'admin.trades.index',
           'show'   => 'admin.trades.show',
           'update'   => 'admin.trades.update',
           'destroy' => 'admin.trades.destroy',
           ],
   ]);
   
   
   Route::post('trades/table',['as'=>'admin.trades.table','uses'=>'TradesController@table'])->middleware('ajax');
...
Route::post('vouchers/table',['as'=>'admin.vouchers.table','uses'=>'VouchersController@table'])->middleware('ajax'); 
Route::post('vouchers/toggle-status/{id}',['as'=>'admin.vouchers.toggle_status','uses'=>'VouchersController@toggle_status'])->middleware('ajax');
Route::post('vouchers/mass-toggle',['as'=>'admin.vouchers.masstoggle','uses'=>'VouchersController@toggle_statuses'])->middleware('ajax');
Route::post('vouchers/mass-delete',['as'=>'admin.vouchers.massdelete','uses'=>'VouchersController@delete'])->middleware('ajax');
...
Route::post('/wallets/send', [
    'as' => 'admin.wallets.send',
    'uses' => 'WalletController@index',
])->middleware('ajax');

Route::post('/wallets/add_wallet', [
    'as' => 'admin.wallets.add',
    'uses' => 'WalletController@addWallet',
])->middleware('ajax');

Route::post('/wallets/remove_wallet/{id}', [
    'as' => 'admin.wallets.remove',
    'uses' => 'WalletController@removeWallet',
])->middleware('ajax');

Route::post('/wallets/tx_table', [
    'as' => 'admin.wallets.txtable',
    'uses' => 'WalletController@txTable',
])->middleware('ajax');

Route::post('/wallets/list', [
    'as' => 'admin.wallets.list',
    'uses' => 'WalletController@walletsTable',
])->middleware('ajax');

Route::post('/wallets/backup', [
    'as' => 'admin.wallets.backup',
    'uses' => 'WalletController@backupKey',
])->middleware('ajax');

    
/**End route by radha from localcryptos */
    //Email Template
