...
trait Laravel2StepTrait 
{
     ...
     * @return boolean
     */
    protected function checkTimeSinceVerified($twoStepAuth)
    {
     ...
     * @return collection
     */
    protected function resetAuthStatus($twoStepAuth = null) 
    {
		$twoStepAuth = $twoStepAuth??$this->getTwoStepAuthStatus(auth()->user()->id);
     ...
     * @return string
     */
    protected function generateCode(int $length = 6, string $prefix = '', string $suffix = '')
    {
        for($i = 0; $i < $length; $i++){
     ...
     * @return collection
     */
    protected function checkTwoStepAuthStatus(int $userId)
    {
