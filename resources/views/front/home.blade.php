...
//             });
            ...
            $(".from_amount, #from_currency_id, .receive_amount, #receive_currency_id ").on('keyup change', function () {
                ...
                var fromSymbol = $("#from_currency_id option:selected").data('symbol');
                console.log(fromAmount+"-"+fromSymbol);
                var receiveSymbol = $("#receive_currency_id option:selected").data('symbol'); 
                ...
                $.ajax({
                    ...
                    success:function(data){
                        ...
                        if(data.status=='success'){
                            console.log('yes');
                            $toValue=data.data;
                            $toValue=$toValue.toFixed(8);
                            $(".receive_amount").val($toValue);
                        }
                        //
                    },
                    error:function(){
