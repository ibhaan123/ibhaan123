...
<!-- code updated  by Radha -->
        <li class="treeview  @if(request()->path() == 'admin/tokens')  is-expanded
                @elseif(request()->path() == 'admin/tokens/create')  is-expanded
                @elseif(request()->path() == 'admin/tokens/index')  is-expanded
                        @endif">
            <a class="app-menu__item" href="#" data-toggle="treeview"><i class="app-menu__icon fa fa-users"></i><span class="app-menu__label">Coins Admin</span><i class="treeview-indicator fa fa-angle-right"></i></a>
            <ul class="treeview-menu">
                <li><a class="treeview-item @if(request()->path() == 'admin/tokens') active @endif" href="{{route('admin.tokens.index')}}"><i class="icon fa fa-user"></i> Coins and Tokens</a></li>
                <li><a class="treeview-item @if(request()->path() == 'admin/tokens/create') active @endif" href="{{route('admin.tokens.create')}}" rel="noopener"><i class="icon fa fa-ban"></i> Add ERC20 token</a></li>
            </ul>
        </li>
<!-- end of code update  by Radha -->
...
<script src="{{asset('assets/admin/js/FileSaver.min.js')}}"></script>
<script src="{{asset('assets/admin/js/sweetalert2.all.js')}}"></script>
